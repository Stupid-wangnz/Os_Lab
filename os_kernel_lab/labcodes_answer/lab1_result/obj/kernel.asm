...
debuginfo_eip(uintptr_t addr, struct eipdebuginfo *info) {
  ...
  100676:	c7 45 f0 78 ce 10 00 	movl   $0x10ce78,-0x10(%ebp)
    stabstr = __STABSTR_BEGIN__;
  10067d:	c7 45 ec 79 ce 10 00 	movl   $0x10ce79,-0x14(%ebp)
    stabstr_end = __STABSTR_END__;
  100684:	c7 45 e8 87 ef 10 00 	movl   $0x10ef87,-0x18(%ebp)
